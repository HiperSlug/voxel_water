...
pub trait Index3d: Copy {
    ...
    fn x_and_i_2d_and_i_3d(self) -> (u32, usize, usize) {
...
impl Index3d for ChunkSmallPos {
    fn i_3d(self) -> usize {
        self.0.as_uvec3().i_3d()
    }

    fn x_and_i_2d(self) -> (u32, usize) {
        self.0.as_uvec3().x_and_i_2d()
    }

    fn xyz(self) -> [u32; 3] {
        Index3d::xyz(self.0.as_uvec3())
    }
}
